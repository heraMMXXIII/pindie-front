...
export const NewCardsListFragment = () => {
    return (
        <>
            <li className={Styles.cards_list__item}>
                <a href="/game-id.html" className={Styles.card_list__link}>
                        ...
                        <div className={Styles.card__content_block}>
                            ...
                            <div className={Styles.card__info_container}>
                                <p className={Styles.card__author}>
                                    Автор: <span className={Styles.cards_list__item}>Mahisto</span>
                                </p>
                ...
                <a href="/game-id.html" className={Styles.card_list__link}>
                    <article className={Styles.card}>
                        ...
                        <div className={Styles.card__content_block}>
                            ...
                            <div className={Styles.card__info_container}>
                                <p className={Styles.card__author}>
                                    Автор: <span className={Styles.cards_list__item}>IDKWIAm</span>    
                                </p>    
                                <p className={Styles.card__votes}>
